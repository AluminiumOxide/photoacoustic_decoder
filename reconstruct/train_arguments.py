...
class TrainArguments:
    ...
    def initialize(self):
        ...
        # general
        self.parser.add_argument('--device', default=device, help='device id (i.e. 0 or 0,1 or cpu)')
        ...
        self.parser.add_argument('--p0_path', default='./test_data/proto_ua/p0/p0_p.mat')  # p0_final
        ...
        self.parser.add_argument('--num_iter_ua', type=int, default=100, help='')  # 直接出图
        self.parser.add_argument('--num_iter_p0', type=int, default=500, help='')  #调用mcx
        ...
        # collect
        self.parser.add_argument('--print_step', default=5, help='')
